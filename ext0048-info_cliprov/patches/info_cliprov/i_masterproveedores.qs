/***************************************************************************
                 i_masterproveedores.qs  -  description
                             -------------------
...
function oficial_obtenerParamInforme(): Array {
  ...
  paramInforme.whereFijo = "dirproveedores.direccionppal = true";
...
function oficial_obtenerOrden(nivel: Number, cursor: FLSqlCursor): String {
  ...
  switch (orden)
  {
    case util.translate("scripts", "Cod. proveedor"):
      ret += "proveedores.codproveedor";
      break;
    case util.translate("scripts", "Proveedor"):
      ret += "proveedores.nombre";
      break;
    case util.translate("scripts", "Población"):
      ret += "dirproveedores.ciudad";
      break;
    case util.translate("scripts", "Provincia"):
      ret += "dirproveedores.provincia";
      break;
    case util.translate("scripts", "País"):
      ret += "dirproveedores.codpais";
      break;
    case util.translate("scripts", "Cod.Postal"):
      ret += "dirproveedores.codpostal";
      break;
