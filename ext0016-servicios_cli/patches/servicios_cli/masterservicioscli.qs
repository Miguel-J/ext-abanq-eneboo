...
class oficial extends interna
{
  ...
  {
    return this.ctx.oficial_preloadMainFilter();
  }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function oficial_pbnGenerarAlbaran_clicked()
{
  ...
  MessageBox.information(util.translate("scripts", "El albarán se generó correctamente."), MessageBox.Ok, MessageBox.NoButton);
...
function oficial_preloadMainFilter()
{
  var f = "";
  ...
  if (datosEjercicio.result > 0) {
    f = "fecha >='" + datosEjercicio.fechainicio + "' AND fecha <= '" + datosEjercicio.fechafin + "'";
  }
  return f;
}
//// OFICIAL /////////////////////////////////////////////////////
