...
{
  function funServiciosCli(context)
  {
    oficial(context);
  }
  function servicioConContrato(nodo: FLDomNode): String {
    return this.ctx.funServiciosCli_servicioConContrato(nodo)
  }
  function encabezadoAlbaranFactura(nodo: FLDomNode): String {
    return this.ctx.funServiciosCli_encabezadoAlbaranFactura(nodo)
  }
  function datosClienteServicio(nodo: FLDomNode): String {
    return this.ctx.funServiciosCli_datosClienteServicio(nodo)
  }
}
//// FUN_SERVICIOS_CLI /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function funServiciosCli_servicioConContrato(nodo: FLDomNode): String {
  ...
  if (contratoMant == "true" || contratoMant == 1) return "C. Mant";
  return "";
}
