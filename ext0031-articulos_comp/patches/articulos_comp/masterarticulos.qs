...
class articuloscomp extends oficial
{
  ...
  function articuloscomp(context)
  {
    oficial(context);
  }
  function init()
  ...
  function copiarTablaArticulosComp(refOrigen, refNueva, progDialog)
  {
    return this.ctx.articuloscomp_copiarTablaArticulosComp(refOrigen, refNueva, progDialog);
  }
...
/** @class_declaration pubArtiComp */
/////////////////////////////////////////////////////////////////
//// PUB ARTICULOS COMP /////////////////////////////////////////
class pubArtiComp extends ifaceCtx
{
  function pubArtiComp(context)
  {
    ifaceCtx(context);
  }
  function pub_copiarTablaArticulosComp(refOrigen, refNueva, progDialog)
  {
    return this.copiarTablaArticulosComp(refOrigen, refNueva, progDialog);
  }
}
//// PUB ARTICULOS COMP /////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
{
  if (this.cursor().mainFilter().startsWith("1 = 1")) {
    debug("setAction");
...
function articuloscomp_copiarTablaArticulosComp(refOrigen, refNueva, progDialog)
{
  ...
  if (progDialog) {
    AQUtil.createProgressDialog(sys.translate("Copiando componentes"), q.size());
  }
  var p = 0;
  while (q.next()) {
    if (progDialog) {
