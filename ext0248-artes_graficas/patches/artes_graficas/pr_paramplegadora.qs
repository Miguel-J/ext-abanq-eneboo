/***************************************************************************
                 pr_paramplegadora.qs  -  description
                             -------------------
...
function oficial_cargarDatos()
{
  ...
  this.child("fdbPalas").setValue(eParam.attribute("Palas"));
  this.child("fdbCuchillas").setValue(eParam.attribute("Cuchillas"));

  this.child("fdbTiempoPrepPala").setValue(eParam.attribute("TiempoPrepPala"));
  this.child("fdbTiempoPrepCuchilla").setValue(eParam.attribute("TiempoPrepCuchilla"));
...
function oficial_guardarDatos(): FLDomDocument {
  ...
  var palas: Number = cursor.valueBuffer("palas");
  if (isNaN(palas))
  {
    palas = 0;
  }
  ...
  var cuchillas: Number = cursor.valueBuffer("cuchillas");
  if (isNaN(cuchillas))
  {
    cuchillas = 0;
  }
  ...
  var tiempoPrepPala: String = cursor.valueBuffer("tiempopreppala");
  if (isNaN(tiempoPrepPala))
  {
    tiempoPrepPala = 0;
  }
  ...
  var tiempoPrepCuchilla: String = cursor.valueBuffer("tiempoprepcuchilla");
  if (isNaN(tiempoPrepCuchilla))
  {
    tiempoPrepCuchilla = 0;
  }
  ...
  var uniHora: Number = cursor.valueBuffer("unihora");
  if (isNaN(uniHora))
  {
    uniHora = 0;
  }
