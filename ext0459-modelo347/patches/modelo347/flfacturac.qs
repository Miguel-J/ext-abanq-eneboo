...
class modelo347 extends oficial
{
  ...
  {
    return this.ctx.modelo347_datosConceptoAsiento(cur);
  }
}
//// MODELO 347 /////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
function modelo347_datosConceptoAsiento(cur)
{
  var _i = this.iface;
  var datosAsiento = [];
  ...
  switch (cur.table()) {
    ...
    default: {
      datosAsiento = _i.__datosConceptoAsiento(cur);
      break;
    }
  }
