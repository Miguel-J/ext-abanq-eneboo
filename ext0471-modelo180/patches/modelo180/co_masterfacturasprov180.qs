/***************************************************************************
                 co_masterfacturasprov180.qs  -  description
                             -------------------
    begin                : mart mar 30 2009
...
function oficial_refrescarTotales()
{
  ...
  if (codProveedor) {
    nomProveedor = util.sqlSelect("proveedores", "nombre", "codproveedor = '" + codProveedor + "'");
  }
  if (!nomProveedor) {
    nomProveedor = "";
  }
  this.child("lblNomProveedor").text = codProveedor + " - " + nomProveedor;
}
//// OFICIAL /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
