...
function modelo340_bufferChanged(fN)
{
  ...
  switch (fN) {
    case "claveoperacion340": {
      sys.setObjText(this, "fdbDesglose340", formfacturasprov.iface.pub_commonCalculateField("desglose340", cursor));
    ...
    case "manual340": {
      ...
      if (!cursor.valueBuffer("manual340")) {
        sys.setObjText(this, "fdbClaveOperacion340", formfacturasprov.iface.pub_commonCalculateField("claveoperacion340", cursor));
      }
      break;
    }
    default: {
...
function modelo340_actualizarLineasIva(curFactura)
{
  ...
  curFactura.setValueBuffer("claveoperacion340", formfacturasprov.iface.pub_commonCalculateField("claveoperacion340", curFactura));
  curFactura.setValueBuffer("desglose340", formfacturasprov.iface.pub_commonCalculateField("desglose340", curFactura));
  return true;
}
