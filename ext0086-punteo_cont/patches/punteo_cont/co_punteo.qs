...
class oficial extends interna
{
  ...
  function puntear()
  {
    return this.ctx.oficial_puntear();
  }
  function casar()
  {
    return this.ctx.oficial_casar();
  }
  function actualizarSaldoP()
  {
    return this.ctx.oficial_actualizarSaldoP();
  }
  function actualizarSaldoC()
  {
    return this.ctx.oficial_actualizarSaldoC();
  }
...
{
  var curP = this.child("tdbPartidasPunteo").cursor();
