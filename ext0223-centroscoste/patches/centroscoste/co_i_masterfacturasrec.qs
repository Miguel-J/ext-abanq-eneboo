...
function centrosCoste_lanzar()
{
  ...
  var groupBy: String = "co_partidas.idcontrapartida,co_partidas.codserie, co_partidas.factura,co_partidas.documento,co_asientos.fecha, co_asientos.numero, co_asientos.idasiento,co_asientos.codejercicio,co_partidas.idsubcuenta,co_partidas.codcontrapartida, sc2.descripcion, co_partidas.cifnif,co_partidas.iva, co_partidas.recargo,co_partidas.idasiento";
