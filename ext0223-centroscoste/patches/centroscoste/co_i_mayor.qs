...
function centrosCoste_agregarCentro(): Boolean {
  ...
  flcontinfo.iface.agregarCentro(cursor, "mayor");
...
function centrosCoste_eliminarCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), codCentro, "mayor");
...
function centrosCoste_eliminarTodosCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), "", "mayor");
...
function centrosCoste_agregarSubcentro(): Boolean {
  ...
  flcontinfo.iface.agregarSubcentro(cursor, "mayor");
  this.child("tdbSubcentros").refresh();
}
...
function centrosCoste_eliminarSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), codSubcentro, "mayor");
...
function centrosCoste_eliminarTodosSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), "", "mayor");
