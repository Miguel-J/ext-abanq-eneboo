...
function centrosCoste_agregarCentro(): Boolean {
  ...
  flcontinfo.iface.agregarCentro(cursor, "diario");
...
function centrosCoste_eliminarCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), codCentro, "diario");
...
function centrosCoste_eliminarTodosCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), "", "diario");
...
function centrosCoste_agregarSubcentro(): Boolean {
  ...
  flcontinfo.iface.agregarSubcentro(cursor, "diario");
  this.child("tdbSubcentros").refresh();
}
...
function centrosCoste_eliminarSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), codSubcentro, "diario");
...
function centrosCoste_eliminarTodosSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), "", "diario");
