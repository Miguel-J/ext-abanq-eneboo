...
{
  function centrosCoste(context)
  {
    oficial(context);
  }
  function init()
  {
    this.ctx.centrosCoste_init();
  }
...
function centrosCoste_agregarCentro(): Boolean {
  ...
  flcontinfo.iface.agregarCentro(cursor, "cuentasanuales");
...
function centrosCoste_eliminarCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), codCentro, "cuentasanuales");
...
function centrosCoste_eliminarTodosCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), "", "cuentasanuales");
...
function centrosCoste_agregarSubcentro(): Boolean {
  ...
  flcontinfo.iface.agregarSubcentro(cursor, "cuentasanuales");
  this.child("tdbSubcentros").refresh();
}
...
function centrosCoste_eliminarSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), codSubcentro, "cuentasanuales");
...
function centrosCoste_eliminarTodosSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), "", "cuentasanuales");
