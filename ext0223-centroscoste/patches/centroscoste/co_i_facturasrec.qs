...
function centrosCoste_agregarCentro(): Boolean {
  ...
  flcontinfo.iface.agregarCentro(cursor, "facturasrec");
...
function centrosCoste_eliminarCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), codCentro, "facturasrec");
...
function centrosCoste_eliminarTodosCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), "", "facturasrec");
...
function centrosCoste_agregarSubcentro(): Boolean {
  ...
  flcontinfo.iface.agregarSubcentro(cursor, "facturasrec");
  this.child("tdbSubcentros").refresh();
}
...
function centrosCoste_eliminarSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), codSubcentro, "facturasrec");
...
function centrosCoste_eliminarTodosSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), "", "facturasrec");
