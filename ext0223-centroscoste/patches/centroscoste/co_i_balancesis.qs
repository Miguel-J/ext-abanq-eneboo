...
function centrosCoste_agregarCentro(): Boolean {
  ...
  flcontinfo.iface.agregarCentro(cursor, "balancesis");
...
function centrosCoste_eliminarCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), codCentro, "balancesis");
...
function centrosCoste_eliminarTodosCentro()
{
  ...
  flcontinfo.iface.eliminarCentro(this.cursor(), "", "balancesis");
...
function centrosCoste_agregarSubcentro(): Boolean {
  ...
  flcontinfo.iface.agregarSubcentro(cursor, "balancesis");
  this.child("tdbSubcentros").refresh();
}
...
function centrosCoste_eliminarSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), codSubcentro, "balancesis");
...
function centrosCoste_eliminarTodosSubcentro()
{
  ...
  flcontinfo.iface.eliminarSubcentro(this.cursor(), "", "balancesis");
