...
class cambioIva extends oficial
{
  ...
  function cambioIva(context)
  {
    oficial(context);
  }
  function campoImpuesto(campo, codImpuesto, fecha, cliProv)
  {
    return this.ctx.cambioIva_campoImpuesto(campo, codImpuesto, fecha, cliProv);
  }
...
/////////////////////////////////////////////////////////////////
//// CAMBIO_IVA /////////////////////////////////////////////////
function cambioIva_campoImpuesto(campo, codImpuesto, fecha, cliProv)
{
...
function cambioIva_validarIvas(curDoc: FLSqlCursor): Boolean {
  ...
  switch (tabla)
  {
    ...
    case "albaranesprov": {
      tablaLineas = "lineasalbaranesprov";
      break;
    }
    case "facturasprov": {
      tablaLineas = "lineasfacturasprov";
      break;
    }
    default: {
      return -1;
