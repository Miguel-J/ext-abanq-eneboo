...
/////////////////////////////////////////////////////////////////
//// PESOS Y MEDIDAS //////////////////////////////////////// ///
class medidas extends oficial
{
  function medidas(context)
  {
    oficial(context);
  }
  ...
  function beforeCommit_pesosmedidas(curP)
  {
    return this.ctx.medidas_beforeCommit_pesosmedidas(curP);
  }
}
//// PESOS Y MEDIDAS ////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// PUB PESOS Y MEDIDAS ////////////////////////////////////////
class pubMedidas extends ifaceCtx
{
  function pubMedidas(context)
  {
    ifaceCtx(context);
  }
...
function medidas_beforeCommit_pesosmedidas(curP)
{
  var _i = this.iface;

  if (!_i.controlDatosMod(curP)) {
    return false;
  }
