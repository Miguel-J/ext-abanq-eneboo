...
class oficial extends interna
{
  ...
  function validarTareaPlay()
  {
    return this.ctx.oficial_validarTareaPlay();
  }
  ...
  function ocultaBotonCerrar()
  {
    return this.ctx.oficial_ocultaBotonCerrar();
  }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// OFICIAL /////////////////////////////////////////////////////
function oficial_ocultaBotonCerrar()
{
...
{
  if (!this.iface.validarTareaPlay()) {
    return false;
  }
...
function oficial_validarTareaPlay()
{
  var util = new FLUtil;
  var trabajador = this.iface.ledTrabajador.text;
  if (!trabajador || trabajador == "") {
    return false;
  }
  if (!util.sqlSelect("pr_trabajadores", "idtrabajador", "idtrabajador = '" + trabajador + "'")) {
    MessageBox.warning(util.translate("scripts", "El trabajador %1 no existe").arg(trabajador), MessageBox.Ok, MessageBox.NoButton);
    return false;
  }
  var idTarea: String = this.iface.ledTarea.text;
  if (!idTarea || idTarea == "") {
  ...
  var estado = util.sqlSelect("pr_tareas", "estado", "idtarea = '" + idTarea + "'")
  if (!estado || (estado != "PTE" && estado != "EN CURSO")) {
    sys.warnMsgBox(sys.translate("La tarea %1 no existe o no está PTE o EN CURSO").arg(idTarea));
    return false;
  }
  return true;
}
