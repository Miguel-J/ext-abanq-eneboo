...
class oficial extends interna
{
  ...
  {
    return this.ctx.oficial_habilitaLote();
  }
  function filtroCodLote()
  {
    return this.ctx.oficial_filtroCodLote();
  }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function interna_calculateField(fN)
{
  ...
  switch (fN) {
    case "fechaprev": {
      var d = new Date;
      valor = (cursor.valueBuffer("estado") == "HECHO") ? "" : d.toString();
      break;
    }
    case "fechareal": {
      var d = new Date;
    ...
    case "horareal": {
      var d = new Date;
      valor = (cursor.valueBuffer("estado") == "HECHO") ? d.toString().right(8) : "";
      break;
    }
  }
  return valor;
...
//////////////////////////////////////////////////////////////////
//// OFICIAL /////////////////////////////////////////////////////
function oficial_filtroCodLote()
{
  var _i = this.iface;
  var cursor = this.cursor();
...
function oficial_mostrarDatosDoc()
{
  ...
  // PEDIDO DE CLIENTE
  if (idLineaPC && idLineaPC != 0) {
    debug("ENTRA PC " + idLineaPC);
...
function oficial_bufferChanged(fN)
{
  ...
  switch (fN) {
    case "estado": {
      sys.setObjText(this, "fdbFechaPrev", _i.calculateField("fechaprev"));
      sys.setObjText(this, "fdbFechaReal", _i.calculateField("fechareal"));
      sys.setObjText(this, "fdbHoraReal", _i.calculateField("horareal"));
      _i.habilitaLote();
      break;
    }
    case "referencia": {
...
function oficial_habilitaLote()
{
  var cursor = this.cursor();
  var referencia = cursor.valueBuffer("referencia");
  if (AQUtil.sqlSelect("articulos", "tipostock", "referencia = '" + referencia + "'") != "Lotes") {
    this.child("fdbCodLote").setDisabled(true);
  } else {
    if (cursor.valueBuffer("estado") == "HECHO") {
      this.child("fdbCodLote").setDisabled(false);
    } else {
      this.child("fdbCodLote").setDisabled(true);
    }
