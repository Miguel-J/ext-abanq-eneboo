/***************************************************************************
                 i_prevcobros.qs  -  description
                             -------------------
    begin                : mie dic 21 2006
  ...
  switch (fN) {
    ...
    case "codintervalo": {
      ...
      if (cursor.valueBuffer("codintervalo")) {
        ...
        cursor.setValueBuffer("d_recibosprov_fechav", intervalo.desde);
        cursor.setValueBuffer("h_recibosprov_fechav", intervalo.hasta);
      }
      break;
    }
  }
