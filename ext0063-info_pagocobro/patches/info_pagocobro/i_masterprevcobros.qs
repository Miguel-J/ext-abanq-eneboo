...
function oficial_lanzar()
{
  ...
  if (cursor.valueBuffer("emitidos"))
    where += "reciboscli.estado = '" + util.translate("scripts", "Emitido") + "'";

  if (cursor.valueBuffer("pagados")) {
    if (where)  where += " OR";
    where += " reciboscli.estado = '" + util.translate("scripts", "Pagado") + "'";
  }

  if (cursor.valueBuffer("devueltos")) {
    if (where)  where += " OR";
    where += " reciboscli.estado = '" + util.translate("scripts", "Devuelto") + "'";
  }

  if (where)
    where = "(" + where + ")";

  var orderBy: String = "facturascli.codcliente,reciboscli.codigo";
