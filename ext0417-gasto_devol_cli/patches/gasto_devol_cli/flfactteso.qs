...
{
  function gastoDevol(context)
  {
    oficial(context);
  }
  function datosReciboCli(curFactura, oRecibo)
  {
    return this.ctx.gastoDevol_datosReciboCli(curFactura, oRecibo);
  }
  function importeReciboPagoDevolCli(curPD, recibo)
  {
    return this.ctx.gastoDevol_importeReciboPagoDevolCli(curPD, recibo);
  }
...
/////////////////////////////////////////////////////////////////
//// GASTOS POR DEVOLUCIÓN //////////////////////////////////////
function gastoDevol_datosReciboCli(curFactura, oRecibo)
{
  var _i = this.iface;
  if (!_i.__datosReciboCli(curFactura, oRecibo))
    return false;

  _i.curReciboCli.setValueBuffer("importesingd", _i.curReciboCli.valueBuffer("importe"));
  return true;
}

function gastoDevol_importeReciboPagoDevolCli(curPD, recibo)
{
  var _i = this.iface;
  var esPago = _i.esPagoEstePagoDevol(curPD);
  var importeTotal;
  if (esPago) {
