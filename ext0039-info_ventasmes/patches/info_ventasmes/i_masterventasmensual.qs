...
class oficial extends interna
{
  ...
  function poblarTablaBuffer()
  {
    return this.ctx.oficial_poblarTablaBuffer();
  }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function oficial_lanzar()
{
  ...
  // Vaciar la tabla
  var curTab = new FLSqlCursor("i_ventasmensual_buffer");
  var numRegBuf = util.sqlSelect("i_ventasmensual_buffer", "count(id)", "1=1");
...
function oficial_poblarTablaBuffer()
{
  var cursor = this.cursor();
  var util = new FLUtil;
  ...
  util.createProgressDialog(util.translate("scripts", "Recabando datos de facturas..."), q.size());
  ...
  while (q.next()) {
    ...
    util.setLabelText(util.translate("scripts", "Recabando datos de facturas\nArtículo ") + referencia);
