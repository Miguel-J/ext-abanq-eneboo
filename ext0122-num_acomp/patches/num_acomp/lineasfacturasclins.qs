/***************************************************************************
                 lineasfacturasclins.qs  -  description
                             -------------------
...
function interna_validateForm(): Boolean {
  ...
  " AND idfacturaventa <> " + this.cursor().cursorRelation().valueBuffer("idfactura") +
  " AND vendido = 'true'")
  ...
  " AND idlinea <> " + this.cursor().cursorRelation().valueBuffer("idlinea"))
    // Salvo que sea otra línea de ns de esta misma factura
    || util.sqlSelect("lineasfacturasclins", "idlinea",
  "numserie = '" + this.cursor().valueBuffer("numserie") + "'" +
  " AND referencia = '" + this.cursor().valueBuffer("referencia") + "'" +
