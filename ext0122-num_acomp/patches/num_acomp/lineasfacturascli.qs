...
{
  function funNumAcomp(context)
  {
    funNumSerie(context);
  }
  function init()
  {
    return this.ctx.funNumAcomp_init();
  }
  function validateForm(): Boolean { return this.ctx.funNumAcomp_validateForm(); }
  function bufferChanged(fN: String)
  {
    return this.ctx.funNumAcomp_bufferChanged(fN);
  }
  function regenerarNumSerieComp()
  {
    return this.ctx.funNumAcomp_regenerarNumSerieComp();
  }
  function controlNumSerieComp(regenerar: Boolean)
  {
    return this.ctx.funNumAcomp_controlNumSerieComp(regenerar);
  }
  function borrarNumSerieComp()
  {
    return this.ctx.funNumAcomp_borrarNumSerieComp();
  }
}
