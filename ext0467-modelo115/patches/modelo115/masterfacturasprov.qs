...
function modelo115_ejecutarOpcionModelo(opcion: String): Boolean {
  ...
  if (opcion == "115EX")
  {
    MessageBox.information(util.translate("scripts", "La factura %1 será excluida del modelo 115/180").arg(cursor.valueBuffer("codigo")), MessageBox.Ok, MessageBox.NoButton);
  } else {
    MessageBox.information(util.translate("scripts", "La factura %1 será incluida en el modelo 115/180").arg(cursor.valueBuffer("codigo")), MessageBox.Ok, MessageBox.NoButton);
  }
