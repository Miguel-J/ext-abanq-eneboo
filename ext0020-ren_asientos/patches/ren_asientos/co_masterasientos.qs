...
class renAsientos extends oficial
{
  ...
  function masDatosAsiento(curA)
  {
    return this.ctx.renAsientos_masDatosAsiento(curA);
  }
}
//// renAsientos/////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
{
  function renAsientosPub(context)
  {
    ifaceCtx(context);
  }
...
function renAsientos_renumerarAsientos()
{
  ...
  while (curAsientos.next()) {
    ...
    if (curAsientos.valueBuffer("editable") == true) {
      ...
      if (!this.iface.masDatosAsiento(cursorBloqueado)) {
...
function renAsientos_masDatosAsiento(curA)
{
  return true;
}
//// renAsientos ///////////////////////////////////////////////
