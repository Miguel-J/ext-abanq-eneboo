...
/** \D Controla los números de serie en función de la eliminación o creación de líneas de albarán
*/
    ...
    case curLF.Edit:
      ...
      if (curLF.valueBuffer("numserie") != curLF.valueBufferCopy("numserie")) {
        ...
        if (curNS.first()) {
          ...
          if (util.sqlSelect("facturascli", "deabono", "idfactura = " + curLF.valueBuffer("idfactura"))) {
...
catidad servida sólo puede ser 1 en el albarán
\end */
