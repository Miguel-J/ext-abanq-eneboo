...
//// INTERNA /////////////////////////////////////////////////////
/** \C
Este formulario muestra una lista de proveedores de cliente que cumplen un determinado filtro, y permite al usuario seleccionar uno o más proveedores de la lista
\end */
...
function oficial_seleccionarTodos()
{
  ...
  var res = MessageBox.warning(util.translate("scripts", "Se seleccionarán todos los proveedores\n\n¿Continuar?"), MessageBox.No, MessageBox.Yes, MessageBox.NoButton);
