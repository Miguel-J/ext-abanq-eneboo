/***************************************************************************
                 i_vencimientos.qs  -  description
                             -------------------
    begin                : mie dic 22 2005
  ...
  switch (fN) {
    ...
    case "codintervalo": {
      ...
      if (cursor.valueBuffer("codintervalo")) {
        ...
        cursor.setValueBuffer("fechavtodesde", intervalo.desde);
        cursor.setValueBuffer("fechavtohasta", intervalo.hasta);
      }
      break;
    }
  }
