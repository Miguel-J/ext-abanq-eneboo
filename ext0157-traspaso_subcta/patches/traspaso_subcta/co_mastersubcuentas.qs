...
/////////////////////////////////////////////////////////////////
//// TRASPASO SUBCUENTA ///////////////////////////////////////////////
class traspasoSubcta extends oficial
{
  function traspasoSubcta(context)
  {
    oficial(context);
  }
  function init()
  {
    this.ctx.traspasoSubcta_init();
  }
  function traspasarScta()
  {
    return this.ctx.traspasoSubcta_traspasarScta()
  }
}
       //// TRASPASO SUBCUENTA ///////////////////////////////////////////////
       /////////////////////////////////////////////////////////////////
