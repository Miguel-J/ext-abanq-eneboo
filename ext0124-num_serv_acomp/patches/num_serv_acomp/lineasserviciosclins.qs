/***************************************************************************
                 lineasserviciosclins.qs  -  description
                             -------------------
...
function interna_validateForm(): Boolean {
  ...
  if (// Si existe un número de serie que no es de este servicio
    util.sqlSelect("numerosserie", "id",
  "numserie = '" + this.cursor().valueBuffer("numserie") + "'" +
  " AND referencia = '" + this.cursor().valueBuffer("referencia") + "'" +
  " AND idservicioventa <> " + this.cursor().cursorRelation().valueBuffer("idservicio") +
  " AND vendido = 'true'")
    // Salvo que sea otra línea de este mismo servicio
    || util.sqlSelect("lineasservicioscli", "idlinea",
  "numserie = '" + this.cursor().valueBuffer("numserie") + "'" +
  " AND idlinea <> " + this.cursor().cursorRelation().valueBuffer("idlinea"))
    // Salvo que sea otra línea de ns de este mismo servicio
    || util.sqlSelect("lineasserviciosclins", "idlinea",
  "numserie = '" + this.cursor().valueBuffer("numserie") + "'" +
