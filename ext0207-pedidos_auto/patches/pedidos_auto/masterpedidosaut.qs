...
function interna_init()
{
  ...
  //No existen los ficheros .qry ni .kut o .ar
...
function oficial_datosPedido(curPedidoAut: FLSqlCursor): Boolean {
  ...
  var codAlmacen: String = curPedidoAut.valueBuffer("codalmacen");
  ...
  with(this.iface.curPedido)
  {
    ...
    setValueBuffer("fechaentrada", fecha);
...
function oficial_datosLineaPedido(curLineaPedidoAut: FLSqlCursor): Boolean {
  ...
  var util: FLUtil = new FLUtil();
  this.iface.curLineaPedido.setValueBuffer("idpedidoaut", curLineaPedidoAut.valueBuffer("idpedidoaut"));
  this.iface.curLineaPedido.setValueBuffer("referencia", curLineaPedidoAut.valueBuffer("referencia"));
  this.iface.curLineaPedido.setValueBuffer("descripcion", curLineaPedidoAut.valueBuffer("descripcion"));
  this.iface.curLineaPedido.setValueBuffer("cantidad", curLineaPedidoAut.valueBuffer("cantidad"));
