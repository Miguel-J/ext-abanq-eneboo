...
function eFactura_datosProveedorFacturae(nodoFacturae: FLDomNode): Array {
  ...
  datos["codpaisiso"] = datos["idproveedor"].left(2);
  datos["cifnif"] = datos["idproveedor"].right(datos["idproveedor"].length - 2);
...
function eFactura_datosClienteFacturae(nodoFacturae: FLDomNode): Array {
  ...
  datos["codpaisiso"] = datos["idcliente"].left(2);
  datos["cifnif"] = datos["idcliente"].right(datos["idcliente"].length - 2);
...
function eFactura_totalesFacturae(cabecera: Array): String {
  ...
  this.iface.curFacturae.setValueBuffer("totalrecargo", valor);
